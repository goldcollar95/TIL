...
3. 이니셜:  AAS
4. First Name은 arnold이다. (대소문자 구분; T/F):  false equals.
5. First Name은 arnold이다. (대소문자 미구분; T/F):  true equalsIgnore
...
class StringTest {
  public static void main(String[] args) {
	...
	firstInit = first.substring(0, 1);//문자한개만 가져오새요. char <-- 'A'_________________;
